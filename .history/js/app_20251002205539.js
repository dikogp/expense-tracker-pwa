...
window.ExpenseTracker = {
  ...
  updateDashboardStats() {
    ...
    const hasAnyDashboardMarker = document.getElementById('dashboardBalance') || document.getElementById('monthIncome') || document.getElementById('monthExpense');
    if (!hasAnyDashboardMarker) {
      console.log('updateDashboardStats: No dashboard elements present on this page, skipping updates.');
      return; // Hard exit
    }
