...
window.i18n = {
  ...
  translations: {
    en: {
      ...
      budgetDescription: "Start managing your finances better by setting up a monthly budget. Track your spending and stay on top of your financial goals.",
    ...
    id: {
      ...
      budgetDescription: "Mulai kelola keuangan Anda dengan lebih baik dengan mengatur anggaran bulanan. Lacak pengeluaran dan capai tujuan keuangan Anda.",
  ...
  formatCurrency: (amount) => {
    ...
    if (window.innerWidth <= 480 && absAmount >= 1000000) {
      if (absAmount >= 1000000000) {
        ...
        return `${sign}Rp${(absAmount / 1000000000).toFixed(1)}${suffix}`;
      } else if (absAmount >= 1000000) {
        const suffix = currentLang === 'id' ? 'jt' : 'M';
        return `${sign}Rp${(absAmount / 1000000).toFixed(1)}${suffix}`;
      }
    }
...
window.ExpenseTracker = {
  ...
  updateHeaderUserInfo() {
    ...
    if (this.currentUser) {
      ...
      const fullName =
        profileData.fullName || this.currentUser.name || window.i18n.t('defaultUser');
  ...
  updateCategoryOptions() {
    const categorySelects = document.querySelectorAll('select[id*="category"], select[name*="category"]');
    categorySelects.forEach(select => {
      ...
      // Add category options
      Object.entries(window.i18n.translations[window.i18n.currentLanguage].categories || {}).forEach(([key, value]) => {
        const option = document.createElement('option');
        option.value = key;
      ...
      <div class="profile-container">
        <div class="profile-header">
          ...
          <div class="profile-info">
            <h2 class="profile-name">${this.currentUser.name || window.i18n.t('defaultUser')}</h2>
        ...
        <div class="profile-settings">
          <div class="setting-item">
            ...
            <select id="languageSelect" onchange="ExpenseTracker.changeLanguage(this.value)">
              <option value="en" ${window.i18n.currentLanguage === 'en' ? 'selected' : ''}>English</option>
              <option value="id" ${window.i18n.currentLanguage === 'id' ? 'selected' : ''}>Bahasa Indonesia</option>
            </select>
          </div>
        </div>
        ...
        <div class="profile-stats">
          ...
          <div class="stat-card">
            ...
            <div class="stat-detail">
              <span class="income">${stats.incomeCount} ${window.i18n.t('income')}</span>
              <span class="expense">${stats.expenseCount} ${window.i18n.t('expenses')}</span>
            </div>
          </div>
              ...
              <div class="activity-item ${t.type}">
                ...
                <div class="activity-info">
                  <p class="activity-title">
                    ${window.i18n.t(`categories.${t.category}`) || this.categories[t.type]?.[t.category]?.name || window.i18n.t('other')}
