...
const ExpenseTracker = {
      ...
      <div class="modal-body">
        <form id="editProfileForm">
          <div class="form-group">
            ...
            <input type="text" id="fullName" name="fullName" value="${profileData.fullName || this.currentUser.name || ''}" required>
          </div>
          <div class="form-group">
            <label for="job">Pekerjaan</label>
            <input type="text" id="job" name="job" value="${profileData.job || ''}">
          </div>
          <div class="form-group">
            <label for="company">Perusahaan</label>
            <input type="text" id="company" name="company" value="${profileData.company || ''}">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <textarea id="address" name="address" rows="2">${profileData.address || ''}</textarea>
          </div>
  ...
  renderProfileContent() {
    ...
    const profileData = this.currentUser.settings?.profile || {};
    const userFullName = profileData.fullName || this.currentUser.name || "Pengguna";
        ...
        <div class="profile-user-info">
          ...
          <div class="user-info-grid">
            ...
            <div class="info-item">
              ...
              <span class="info-value">${new Date(this.currentUser.createdAt).toLocaleDateString('id-ID', { day: 'numeric', month: 'long', year: 'numeric' })}</span>
            </div>
          </div>
          ${!this.currentUser.isGuest ? `
