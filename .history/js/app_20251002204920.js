  ...
  updateDashboardStats() {
    ...
    const attemptUpdate = (attempt = 0) => {
      try {
        ...
        const updates = [
          { element: dashboardElements.dashboardBalance, value: stats.monthlyBalance },
          { element: dashboardElements.monthIncome, value: stats.monthlyIncome },
          { element: dashboardElements.monthExpense, value: stats.monthlyExpense }
        ];
