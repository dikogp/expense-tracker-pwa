...
window.ExpenseTracker = {
  ...
  addTransaction() {
    ...
    setTimeout(() => {
      ...
      const balanceElement = document.querySelector(".user-balance .balance-amount");
      if (balanceElement) {
        balanceElement.textContent = Utils.formatCurrency(this.stats.monthlyBalance);
      }
  ...
  updateBalance() {
    ...
    if (userBalance) {
      ...
      console.log("Balance updated:", this.stats.monthlyBalance);
    } else {
