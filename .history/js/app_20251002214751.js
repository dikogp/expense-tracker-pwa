...
window.ExpenseTracker = {
  ...
  setBudget() {
    ...
    if (amount <= 0) {
      this.showToast("Masukkan jumlah anggaran yang valid (lebih dari 0)", "error");
      return;
    }
    ...
    try {
      ...
      this.saveUserData();
      this.showToast(`Anggaran untuk ${selectedMonth} berhasil diatur: ${Utils.formatCurrency(amount)}`, "success");
