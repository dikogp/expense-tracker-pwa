...
window.ExpenseTracker = {
  ...
  editTransaction(id) {
    ...
    document.getElementById("editAmount").dataset.rawValue =
      transaction.amount.toString();
    document.getElementById("editDescription").value =
      transaction.description || "";
    document.getElementById("editDate").value = transaction.date;
    document.getElementById("editTime").value = transaction.time || "00:00";
  ...
  updateHeaderUserInfo() {
    ...
    if (this.currentUser) {
      ...
      const fullName = profileData.fullName || this.currentUser.name || 'Pengguna';
