...
window.ExpenseTracker = {
  ...
  updateHistory() {
    console.log("updateHistory called, transactions count:", this.transactions.length);
    ...
    if (filteredTransactions.length === 0) {
      console.log("No filtered transactions found. Total transactions:", this.transactions.length);
