...
window.ExpenseTracker = {
  ...
  addTransaction() {
    ...
    // Panggil updateUI() untuk sinkronisasi data dan tampilan secara menyeluruh
    this.updateUI();

    // Pindah ke dashboard setelah semuanya di-update
  ...
  updateDashboard() {
    ...
    // Update the dashboard in a specific order
    this.updateDashboardStats();  // This includes balance
      ...
      if (mainStatsDisplay) {
        mainStatsDisplay.innerHTML = `
          ...
          <div class="stat-card balance">
            ...
            <div class="stat-value ${stats.monthlyBalance >= 0 ? 'positive' : 'negative'}">
