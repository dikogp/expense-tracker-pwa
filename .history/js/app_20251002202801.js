...
window.ExpenseTracker = {
  ...
  showSection(sectionId) {
    try {
      ...
      // Store previous view before updating current view
      ...
      // Wait a moment to ensure the DOM is ready before updating content
      setTimeout(() => {
        // Handle section-specific updates
        switch (sectionId) {
          case "dashboard":
            console.log('Preparing dashboard content...');
            // First load data
            this.updateGlobalStats();
            // Then update the UI components in a controlled order
            this.updateDashboard();
            this.updateBudget();
  ...
  addTransaction() {
    ...
    // Hitung statistik terlebih dahulu
    this.updateGlobalStats();
    ...
    // Gunakan setTimeout untuk memastikan navigasi terjadi SETELAH data disimpan
    // dan notifikasi toast ditampilkan
    setTimeout(() => {
      // Pindah ke dashboard
